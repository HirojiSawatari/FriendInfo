...
/**
 * Created by Sawatari on 2017/1/30.
 */
...
public class UserLogin extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		fromCode = fromInfo.getInt("code", 0);
		...
		button2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				*/
				...
				if (fromCode == 1){	//由MainActivity进入本界面
					UserLogin.this.finish();
				} else {	//由SplashScreen进入本界面
					Intent mainIntent = new
							Intent(UserLogin.this, MainActivity.class);
					UserLogin.this.startActivity(mainIntent);
					UserLogin.this.finish();
				}
				// }
